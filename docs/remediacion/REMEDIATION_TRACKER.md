...
| --------------------------------------------------- | ----------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| F-012 login eludible                                | Verificado  | U (10, `login-actions.test.ts`)       | Riesgo residual **cerrado** el 2026-08-22: CAPTCHA nativo de Supabase Auth activado; el login reenvía el token en `options.captchaToken` y ya no lo valida por su cuenta. |
